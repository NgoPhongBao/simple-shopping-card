...
const Attribute = () => {
  ...
  const getList = async (query) => {
    setIsLoading(true);
    try {
      const res = await api.get("/attribute", {...query, keyword: query.keyword.trim()});
      const { data = {} } = res;
    ...
    <div className="m-4">
      <div className="my-4">
        <Breadcrumb>
          ...
          <Breadcrumb.Item>Thuộc tính</Breadcrumb.Item>
        </Breadcrumb>
      </div>
      <div className=" h-full fadein">
        ...
        <div className="mt-4 mb-1">
          <Link to="/attribute/add" className="inline-block">
            <Button
              type="primary"
